...
import moe.aisia.kotlinx.alias.JByte
import moe.aisia.kotlinx.alias.JInt
import moe.aisia.kotlinx.alias.JLong
...
inline fun <T, U> T.printlnBy(converter: (T) -> U): T {
   println(converter(this))
   return this
}
